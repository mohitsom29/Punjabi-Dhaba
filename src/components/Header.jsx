import { HeartHandshake, PercentCircle,ShoppingCart,User } from 'lucide-react'
  ...
  return (
    <>
      <nav className='w-full shadow-[rgba(0,_0,_0,_0.24)_0px_1px_8px]'>
        <div className='w-full mx-auto px-2 sm:px-6 lg: py-2'>
          <div className='flex items-center justify-between h-16 w-full'>
            <div className='flex-1 flex items-center justify-between'>
              <div className='flex-shrink-0 flex items-center'>
                 <a href="/">
                    <img className='object-fill w-[13rem]' src='src/assets/Vanakkam.png'
                    alt='website-logo'
                    />
                 </a>
              </div>
              <div className='hidden sm:block sm:ml-6'>
                <div className='flex space-x-4'>
                  <Link to='' className='flex text-gray-500 hover:text-orange-500 hover:font-semibold px-3 py-2 capitalize font-semibold'>
